...
func strglob(tls *libc.TLS, zGlob uintptr, z uintptr) int32 {
	...
	for libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(libc.PostIncUintptr(&zGlob, 1))))) != 0 {
		if c == '*' {
			...
			if (int32(*(*int8)(unsafe.Pointer(z))) == '-' || int32(*(*int8)(unsafe.Pointer(z))) == '+') && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + 1))))*2)))&X_CTYPE_D != 0 {
				z++
			}
			if !(int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z))))*2)))&X_CTYPE_D != 0) {
				return 0
			}
			z++
			for int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z))))*2)))&X_CTYPE_D != 0 {
				z++
			}
		} else {
...
func clipLength(tls *libc.TLS, z uintptr) int32 {
	...
	for n > 0 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n-1)))))*2)))&X_CTYPE_S != 0 {
		n--
	}
	return n
}
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	for i = 0; *(*int8)(unsafe.Pointer(z + uintptr(i))) != 0 && !(int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + uintptr(i)))))*2)))&X_CTYPE_S != 0); i++ {
	}
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) int32 {
	var n int32 = 0
	if int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z))))*2)))&X_CTYPE_S != 0 || int32(*(*int8)(unsafe.Pointer(z))) == '/' && int32(*(*int8)(unsafe.Pointer(z + 1))) == '*' {
		var inC int32 = 0
		var c int32
		...
		for libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(z + uintptr(libc.PostIncInt32(&n, 1)))))) != 0 {
			...
			if int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(c))*2)))&X_CTYPE_S != 0 {
				continue
			}
		...
		var c int32
		for n = 1; libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(z + uintptr(n))))) != 0 && !(int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(c))*2)))&X_CTYPE_S != 0) && c != '"' && c != '\'' && c != ';'; n++ {
		}
	}
	return n
}
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) int32 {
	...
	for i = 0; i < nIn && i < nOut-1 && !(int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(zIn + uintptr(i)))))*2)))&X_CTYPE_S != 0); i++ {
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) int32 {
	var n int32 = 0
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), ts+898, uint64(5)) != 0 || !(int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+5)))))*2)))&X_CTYPE_S != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) int32 {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), ts+904, uint64(7)) == 0 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+7)))))*2)))&X_CTYPE_S != 0 ||
			stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), ts+912, uint64(6)) == 0 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+6)))))*2)))&X_CTYPE_S != 0 {
			return n + len
		}
		if libc.Xstrncmp(tls, z+uintptr(n), ts+919, uint64(4)) == 0 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+4)))))*2)))&X_CTYPE_S != 0 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	*(*int32)(unsafe.Pointer(bp + 376)) = 1
	...
	for libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii))))) != 0 {
		...
		if int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(c))*2)))&X_CTYPE_S != 0 || c == '/' && int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+1)))) == '*' {
			ii = ii + len
			continue
		}
		if c != '-' || int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+1)))) != '-' || !(int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+2))))*2)))&X_CTYPE_A != 0) {
			ii = ii + len
			continue
		}
		...
		for nArg = 0; n < len-2 && nArg < MX_ARG; nArg++ {
			for n < len-2 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+2+n)))))*2)))&X_CTYPE_S != 0 {
				n++
			}
			if n >= len-2 {
				break
		...
		if libc.Xstrcmp(tls, bp+380, ts+1209) == 0 {
			...
			for jj = 7; jj < len-1 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj)))))*2)))&X_CTYPE_S != 0; jj++ {
			}
			zAns += uintptr(jj)
			...
			for jj = 9 - 3*isGlob; jj < len-1 && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj)))))*2)))&X_CTYPE_S != 0; jj++ {
			}
			zAns += uintptr(jj)
			...
			var jj int32
			for jj = 7; jj < len && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj)))))*2)))&X_CTYPE_S != 0; jj++ {
			}
			...
			var rc int32
			var pStmt uintptr
			for jj = 4; jj < len && int32(*(*uint16)(unsafe.Pointer(libc.X_ctype_tab_ + uintptr(1)*2 + uintptr(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj)))))*2)))&X_CTYPE_S != 0; jj++ {
			}
