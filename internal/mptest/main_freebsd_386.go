...
func strglob(tls *libc.TLS, zGlob uintptr, z uintptr) int32 {
	...
	for libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(libc.PostIncUintptr(&zGlob, 1))))) != 0 {
		if c == '*' {
			...
			if (int32(*(*int8)(unsafe.Pointer(z))) == '-' || int32(*(*int8)(unsafe.Pointer(z))) == '+') && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + 1)))), uint32(X_CTYPE_D)) != 0 {
				z++
			}
			if !(__sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z)))), uint32(X_CTYPE_D)) != 0) {
				return 0
			}
			z++
			for __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z)))), uint32(X_CTYPE_D)) != 0 {
				z++
			}
		} else {
...
func errorMessage(tls *libc.TLS, zFormat uintptr, va uintptr) {
	...
	_ = ap
	sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([30]int8{})), bp+8, ts+8, libc.VaList(bp, uintptr(unsafe.Pointer(&g))+32))
	if g.pLog != 0 {
...
func fatalError(tls *libc.TLS, zFormat uintptr, va uintptr) {
	...
	zMsg = sqlite3.Xsqlite3_vmprintf(tls, zFormat, ap)
	_ = ap
	sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([30]int8{})), bp+8, ts+19, libc.VaList(bp, uintptr(unsafe.Pointer(&g))+32))
	if g.pLog != 0 {
		printWithPrefix(tls, g.pLog, bp+8, zMsg)
		libc.Xfflush(tls, g.pLog)
...
func logMessage(tls *libc.TLS, zFormat uintptr, va uintptr) {
	...
	zMsg = sqlite3.Xsqlite3_vmprintf(tls, zFormat, ap)
	_ = ap
	sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([30]int8{})), bp+8, ts+60, libc.VaList(bp, uintptr(unsafe.Pointer(&g))+32))
	if g.pLog != 0 {
		printWithPrefix(tls, g.pLog, bp+8, zMsg)
		libc.Xfflush(tls, g.pLog)
	}
...
func clipLength(tls *libc.TLS, z uintptr) int32 {
	...
	for n > 0 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n-1))))), uint32(X_CTYPE_S)) != 0 {
		n--
	}
	return n
}
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	for i = 0; *(*int8)(unsafe.Pointer(z + uintptr(i))) != 0 && !(__sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(i))))), uint32(X_CTYPE_S)) != 0); i++ {
	}
...
func evalSql(tls *libc.TLS, p uintptr, zFormat uintptr, va uintptr) int32 {
	...
	*(*uintptr)(unsafe.Pointer(bp + 8)) = uintptr(0)
	...
	sqlite3.Xsqlite3_free(tls, zSql)
	if rc != 0 {
		sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([30]int8{})), bp+12, ts+151, libc.VaList(bp, rc))
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) int32 {
	var n int32 = 0
	if __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z)))), uint32(X_CTYPE_S)) != 0 || int32(*(*int8)(unsafe.Pointer(z))) == '/' && int32(*(*int8)(unsafe.Pointer(z + 1))) == '*' {
		var inC int32 = 0
		var c int32
		...
		for libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(z + uintptr(libc.PostIncInt32(&n, 1)))))) != 0 {
			...
			if __sbistype(tls, int32(uint8(c)), uint32(X_CTYPE_S)) != 0 {
				continue
			}
		...
		var c int32
		for n = 1; libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(z + uintptr(n))))) != 0 && !(__sbistype(tls, int32(uint8(c)), uint32(X_CTYPE_S)) != 0) && c != '"' && c != '\'' && c != ';'; n++ {
		}
	}
	return n
}
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) int32 {
	...
	for i = 0; i < nIn && i < nOut-1 && !(__sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zIn + uintptr(i))))), uint32(X_CTYPE_S)) != 0); i++ {
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) int32 {
	var n int32 = 0
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), ts+898, uint32(5)) != 0 || !(__sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+5))))), uint32(X_CTYPE_S)) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) int32 {
	...
	for *(*int8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), ts+904, uint32(7)) == 0 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+7))))), uint32(X_CTYPE_S)) != 0 ||
			stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), ts+912, uint32(6)) == 0 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+6))))), uint32(X_CTYPE_S)) != 0 {
			return n + len
		}
		if libc.Xstrncmp(tls, z+uintptr(n), ts+919, uint32(4)) == 0 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(z + uintptr(n+4))))), uint32(X_CTYPE_S)) != 0 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	*(*int32)(unsafe.Pointer(bp + 372)) = 1
	...
	for libc.AssignInt32(&c, int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii))))) != 0 {
		...
		if __sbistype(tls, int32(uint8(c)), uint32(X_CTYPE_S)) != 0 || c == '/' && int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+1)))) == '*' {
			ii = ii + len
			continue
		}
		if c != '-' || int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+1)))) != '-' || !(__sbistype(tls, int32(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+2)))), uint32(X_CTYPE_A)) != 0) {
			ii = ii + len
			continue
		}
		...
		n = extractToken(tls, zScript+uintptr(ii)+uintptr(2), len-2, bp+376, int32(unsafe.Sizeof([30]int8{})))
		for nArg = 0; n < len-2 && nArg < MX_ARG; nArg++ {
			for n < len-2 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+2+n))))), uint32(X_CTYPE_S)) != 0 {
				n++
			}
			if n >= len-2 {
				break
		...
		if libc.Xstrcmp(tls, bp+376, ts+1209) == 0 {
			...
			for jj = 7; jj < len-1 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj))))), uint32(X_CTYPE_S)) != 0; jj++ {
			}
			zAns += uintptr(jj)
			...
			for jj = 9 - 3*isGlob; jj < len-1 && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zAns + uintptr(jj))))), uint32(X_CTYPE_S)) != 0; jj++ {
			}
			zAns += uintptr(jj)
			...
			var jj int32
			for jj = 7; jj < len && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj))))), uint32(X_CTYPE_S)) != 0; jj++ {
			}
			...
			var rc int32
			var pStmt uintptr
			for jj = 4; jj < len && __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zScript + uintptr(ii+jj))))), uint32(X_CTYPE_S)) != 0; jj++ {
			}
			...
			sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([1000]int8{})), bp+606, ts+1450,
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	for i = 0; i < nArg; i++ {
		libc.Xfprintf(tls, libc.X__stderrp, ts+2319, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(azArg + uintptr(i)*4))))
	}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 {
	...
	*(*int32)(unsafe.Pointer(bp + 232)) = argc - 2
	sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([32]int8{})), uintptr(unsafe.Pointer(&g))+32, ts+2477, libc.VaList(bp+16, libc.Xgetpid(tls)))
	...
	if zClient != 0 {
		...
		sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([32]int8{})), uintptr(unsafe.Pointer(&g))+32, ts+2593,
