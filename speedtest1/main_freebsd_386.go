...
func integerValue(tls *libc.TLS, zArg uintptr) int32 {
	...
	if int32(*(*int8)(unsafe.Pointer(zArg))) == '0' && int32(*(*int8)(unsafe.Pointer(zArg + 1))) == 'x' {
		...
		for __sbistype(tls, int32(*(*int8)(unsafe.Pointer(zArg))), uint32(X_CTYPE_D)) != 0 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for n > 0 && (int32(*(*int8)(unsafe.Pointer(zSql + uintptr(n-1)))) == ';' || __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zSql + uintptr(n-1))))), uint32(X_CTYPE_S)) != 0) {
		n--
	}
	if g.bExplain != 0 {
