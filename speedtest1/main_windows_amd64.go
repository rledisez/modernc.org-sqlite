...
func vsnwprintf(tls *libc.TLS, __stream uintptr, __n uint64, __format uintptr, __local_argv uintptr) int32 {
	return libc.X__mingw_vsnwprintf(tls, __stream, __n, __format, __local_argv)
}

func vswprintf(tls *libc.TLS, __stream uintptr, __count uint64, __format uintptr, __local_argv uintptr) int32 {
...
func speedtest1_begin_test(tls *libc.TLS, iTestNum int32, zTestName uintptr, va uintptr) {
	...
	if g.pScript != 0 {
		fprintf(tls, g.pScript, ts+3001, libc.VaList(bp, iTestNumber, n, zName))
	}
	if g.bSqlOnly != 0 {
		printf(tls, ts+3024, libc.VaList(bp+24, iTestNum, zName, NAMEWIDTH-n, uintptr(unsafe.Pointer(&zDots))))
	} else {
		printf(tls, ts+3044, libc.VaList(bp+56, iTestNum, zName, NAMEWIDTH-n, uintptr(unsafe.Pointer(&zDots))))
...
func speedtest1_end_test(tls *libc.TLS) {
	...
	if g.pScript != 0 {
		fprintf(tls, g.pScript, ts+3081, libc.VaList(bp, iTestNumber))
	}
	if !(g.bSqlOnly != 0) {
		*(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 24)) += iElapseTime
		printf(tls, ts+3097, libc.VaList(bp+8, int32(iElapseTime/int64(1000)), int32(iElapseTime%int64(1000))))
	}
	if g.pStmt != 0 {
...
func speedtest1_final(tls *libc.TLS) {
	...
	if !(g.bSqlOnly != 0) {
		printf(tls, ts+3108, libc.VaList(bp, NAMEWIDTH-5, uintptr(unsafe.Pointer(&zDots)),
			int32(g.iTotal/int64(1000)), int32(g.iTotal%int64(1000))))
	}
	if g.bVerify != 0 {
		var i int32
		printf(tls, ts+3136, libc.VaList(bp+32, g.nResByte))
		HashUpdate(tls, ts+3161, uint32(1))
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			printf(tls, ts+3163, libc.VaList(bp+40, int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3152 + 259 + uintptr(i))))))
		}
		if g.hashFile != 0 && g.hashFile != libc.X__acrt_iob_func(tls, uint32(1)) {
			libc.Xfclose(tls, g.hashFile)
		}
		printf(tls, ts+3161, 0)
	}
}
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	if g.bExplain != 0 {
		printf(tls, ts+3168, 0)
	}
	printf(tls, ts+3177, libc.VaList(bp, n, zSql))
	if g.bExplain != 0 &&
		...
		printf(tls, ts+3177, libc.VaList(bp+16, n, zSql))
	}
}
...
func speedtest1_exec(tls *libc.TLS, zFormat uintptr, va uintptr) {
	...
	if g.bSqlOnly != 0 {
		...
		*(*uintptr)(unsafe.Pointer(bp + 32)) = uintptr(0)
		var rc int32
		if g.pScript != 0 {
			fprintf(tls, g.pScript, ts+3208, libc.VaList(bp, zSql))
		}
...
func speedtest1_once(tls *libc.TLS, zFormat uintptr, va uintptr) uintptr {
	...
	if g.bSqlOnly != 0 {
		...
		if g.pScript != 0 {
			...
			fprintf(tls, g.pScript, ts+3262, libc.VaList(bp+8, z))
...
func speedtest1_run(tls *libc.TLS) {
	...
	if g.pScript != 0 {
		...
		fprintf(tls, g.pScript, ts+3262, libc.VaList(bp, z))
		sqlite3.Xsqlite3_free(tls, z)
	}
...
func traceCallback(tls *libc.TLS, NotUsed uintptr, zSql uintptr) {
	...
	fprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), ts+3177, libc.VaList(bp, n, zSql))
}
...
func testset_debug1(tls *libc.TLS) {
	...
	for i = uint32(1); i <= n; i++ {
		...
		printf(tls, ts+23235, libc.VaList(bp, i, x1, x2, bp+32))
	}
}
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) int32 {
	...
	printf(tls, ts+23251, libc.VaList(bp, *(*uintptr)(unsafe.Pointer(azVal))))
	return SQLITE_OK
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 {
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23321) == 0 {
				...
				printf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+176, *(*uintptr)(unsafe.Pointer(argv))))
				libc.Xexit(tls, 0)
			} else {
	...
	for __ccgo1 := true; __ccgo1; __ccgo1 = *(*int8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if g.iTotal > int64(0) || zComma != uintptr(0) {
			printf(tls, ts+24519, libc.VaList(bp+424, zThisTest))
		}
	...
	if showStats != 0 {
		...
		printf(tls, ts+25237, libc.VaList(bp+544, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_MALLOC_COUNT, bp+608, bp+612, 0)
		printf(tls, ts+25282, libc.VaList(bp+560, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_PAGECACHE_OVERFLOW, bp+608, bp+612, 0)
		printf(tls, ts+25327, libc.VaList(bp+576, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_MALLOC_SIZE, bp+608, bp+612, 0)
		printf(tls, ts+25372, libc.VaList(bp+592, *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_PAGECACHE_SIZE, bp+608, bp+612, 0)
		printf(tls, ts+25414, libc.VaList(bp+600, *(*int32)(unsafe.Pointer(bp + 612))))
	}
