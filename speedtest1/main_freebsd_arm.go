...
func __sbmaskrune_l(tls *libc.TLS, __c int32, __f uint32, __loc uintptr) int32 {
	bp := tls.Alloc(4)
	defer tls.Free(4)
...
func __sbistype_l(tls *libc.TLS, __c int32, __f uint32, __loc uintptr) int32 {
...
func integerValue(tls *libc.TLS, zArg uintptr) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(zArg))) == '0' && int32(*(*uint8)(unsafe.Pointer(zArg + 1))) == 'x' {
		...
		for __sbistype(tls, int32(*(*uint8)(unsafe.Pointer(zArg))), uint32(X_CTYPE_D)) != 0 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for n > 0 && (int32(*(*uint8)(unsafe.Pointer(zSql + uintptr(n-1)))) == ';' || __sbistype(tls, int32(*(*uint8)(unsafe.Pointer(zSql + uintptr(n-1)))), uint32(X_CTYPE_S)) != 0) {
		n--
	}
	if g.bExplain != 0 {
...
func traceCallback(tls *libc.TLS, NotUsed uintptr, zSql uintptr) {
	...
	libc.Xfprintf(tls, libc.X__stderrp, ts+3177, libc.VaList(bp, n, zSql))
}
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) int32 {
	...
	libc.Xprintf(tls, ts+23251, libc.VaList(bp, *(*uintptr)(unsafe.Pointer(azVal))))
	return SQLITE_OK
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 {
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*uint8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23321) == 0 {
				doAutovac = 1
			} else if libc.Xstrcmp(tls, z, ts+23332) == 0 {
				g.doBigTransactions = 1
			} else if libc.Xstrcmp(tls, z, ts+23349) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				cacheSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23383) == 0 {
				doExclusive = 1
			} else if libc.Xstrcmp(tls, z, ts+23393) == 0 {
				doFullFSync = 1
			} else if libc.Xstrcmp(tls, z, ts+23403) == 0 {
				g.doCheckpoint = 1
			} else if libc.Xstrcmp(tls, z, ts+23414) == 0 {
				g.bSqlOnly = 1
				g.bExplain = 1
			} else if libc.Xstrcmp(tls, z, ts+23422) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23359, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				i = i + 2
			} else if libc.Xstrcmp(tls, z, ts+23427) == 0 {
				doIncrvac = 1
			} else if libc.Xstrcmp(tls, z, ts+23438) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23446) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23450) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23359, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				i = i + 2
			} else if libc.Xstrcmp(tls, z, ts+23460) == 0 {
				memDb = 1
			} else if libc.Xstrcmp(tls, z, ts+23466) == 0 {
				sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_MULTITHREAD, 0)
			} else if libc.Xstrcmp(tls, z, ts+23478) == 0 {
				sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_MEMSTATUS, libc.VaList(bp+56, 0))
			} else if libc.Xstrcmp(tls, z, ts+23488) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				mmapSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23493) == 0 {
				openFlags = openFlags | SQLITE_OPEN_NOMUTEX
			} else if libc.Xstrcmp(tls, z, ts+23501) == 0 {
				noSync = 1
			} else if libc.Xstrcmp(tls, z, ts+23508) == 0 {
				g.zNN = ts + 23516
			} else if libc.Xstrcmp(tls, z, ts+23525) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23532) == 0 {
					g.hashFile = libc.X__stdoutp
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23534)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23537, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23567) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				pageSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23576) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23359, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				g.nRepeat = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23613) == 0 {
				g.bReprepare = 1
			} else if libc.Xstrcmp(tls, z, ts+23623) == 0 {
			...
			} else if libc.Xstrcmp(tls, z, ts+23647) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				if g.pScript != 0 {
					libc.Xfclose(tls, g.pScript)
				}
				g.pScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)), ts+23534)
				if g.pScript == uintptr(0) {
					fatal_error(tls, ts+23654, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
			} else if libc.Xstrcmp(tls, z, ts+23687) == 0 {
				g.bSqlOnly = 1
			} else if libc.Xstrcmp(tls, z, ts+23695) == 0 {
				g.bMemShrink = 1
			} else if libc.Xstrcmp(tls, z, ts+23709) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				g.szTest = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23714) == 0 {
				showStats = 1
			} else if libc.Xstrcmp(tls, z, ts+23720) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) < '0' || int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) > '9' || int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)) + 1))) != 0 {
					fatal_error(tls, ts+23725, 0)
				}
				g.eTemp = int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) - '0'
			} else if libc.Xstrcmp(tls, z, ts+23778) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zTSet = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23786) == 0 {
				doTrace = 1
			} else if libc.Xstrcmp(tls, z, ts+23792) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				nThread = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23800) == 0 {
				zEncoding = ts + 23800
			} else if libc.Xstrcmp(tls, z, ts+23808) == 0 {
				zEncoding = ts + 23808
			} else if libc.Xstrcmp(tls, z, ts+23816) == 0 {
				g.bVerify = 1
				HashInit(tls)
			} else if libc.Xstrcmp(tls, z, ts+23823) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23827) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				g.nReserve = libc.Xatoi(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23835) == 0 {
				g.stmtScanStatus = 1
			} else if libc.Xstrcmp(tls, z, ts+23850) == 0 {
				if libc.Xstrstr(tls, g.zWR, ts+23864) != uintptr(0) {
				} else if libc.Xstrstr(tls, g.zWR, ts+23872) != uintptr(0) {
					g.zWR = ts + 23879
				} else {
					g.zWR = ts + 6454
				}
				g.zPK = ts + 23594
			} else if libc.Xstrcmp(tls, z, ts+23900) == 0 {
				if libc.Xstrstr(tls, g.zWR, ts+23872) != uintptr(0) {
				} else if libc.Xstrstr(tls, g.zWR, ts+23864) != uintptr(0) {
					g.zWR = ts + 23879
				} else {
					g.zWR = ts + 23872
				}
			} else if libc.Xstrcmp(tls, z, ts+23907) == 0 || libc.Xstrcmp(tls, z, ts+23912) == 0 {
				libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+176, *(*uintptr)(unsafe.Pointer(argv))))
				libc.Xexit(tls, 0)
			} else {
				fatal_error(tls, ts+23914,
	...
	if nHeap > 0 {
		...
		if pHeap == uintptr(0) {
			fatal_error(tls, ts+23998, libc.VaList(bp+216, nHeap))
		}
		rc = sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_HEAP, libc.VaList(bp+224, pHeap, nHeap, mnHeap))
		if rc != 0 {
			fatal_error(tls, ts+24028, libc.VaList(bp+248, rc))
		}
	}
	if doPCache != 0 {
		...
		if rc != 0 {
			fatal_error(tls, ts+24093, libc.VaList(bp+288, rc))
		}
	}
	if nLook >= 0 {
	...
	if sqlite3.Xsqlite3_open_v2(tls, func() uintptr {
		...
		openFlags, zVfs) != 0 {
		fatal_error(tls, ts+24135, libc.VaList(bp+312, zDbName))
	}
	if nLook > 0 && szLook > 0 {
		...
		if rc != 0 {
			fatal_error(tls, ts+24166, libc.VaList(bp+344, rc))
		}
	}
	if g.nReserve > 0 {
	...
	sqlite3.Xsqlite3_create_function(tls, g.db, ts+24202, 0, SQLITE_UTF8, uintptr(0), *(*uintptr)(unsafe.Pointer(&struct {
	...
	if memDb > 0 {
		speedtest1_exec(tls, ts+24209, 0)
	}
	if mmapSize > 0 {
		speedtest1_exec(tls, ts+24234, libc.VaList(bp+368, mmapSize))
	}
	speedtest1_exec(tls, ts+24254, libc.VaList(bp+376, nThread))
	if zKey != 0 {
		speedtest1_exec(tls, ts+24272, libc.VaList(bp+384, zKey))
	}
	if zEncoding != 0 {
		speedtest1_exec(tls, ts+24289, libc.VaList(bp+392, zEncoding))
	}
	if doAutovac != 0 {
		speedtest1_exec(tls, ts+24308, 0)
	} else if doIncrvac != 0 {
		speedtest1_exec(tls, ts+24332, 0)
	}
	if pageSize != 0 {
		speedtest1_exec(tls, ts+24363, libc.VaList(bp+400, pageSize))
	}
	if cacheSize != 0 {
		speedtest1_exec(tls, ts+24383, libc.VaList(bp+408, cacheSize))
	}
	if noSync != 0 {
		speedtest1_exec(tls, ts+24404, 0)
	} else if doFullFSync != 0 {
		speedtest1_exec(tls, ts+24427, 0)
	}
	if doExclusive != 0 {
		speedtest1_exec(tls, ts+24447, 0)
	}
	if zJMode != 0 {
		speedtest1_exec(tls, ts+24477, libc.VaList(bp+416, zJMode))
	}

	if g.bExplain != 0 {
		libc.Xprintf(tls, ts+24500, 0)
	}
	for __ccgo1 := true; __ccgo1; __ccgo1 = *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if g.iTotal > int64(0) || zComma != uintptr(0) {
			libc.Xprintf(tls, ts+24519, libc.VaList(bp+424, zThisTest))
		}
		if libc.Xstrcmp(tls, zThisTest, ts+23274) == 0 {
			testset_main(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24546) == 0 {
			testset_debug1(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24553) == 0 {
			testset_orm(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24557) == 0 {
			testset_cte(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24561) == 0 {
			testset_fp(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24564) == 0 {
			testset_trigger(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24572) == 0 {
		...
		if *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
			var zSql uintptr
			var zObj uintptr
			speedtest1_begin_test(tls, 999, ts+24647, 0)
			for 1 != 0 {
				...
				zSql = sqlite3.Xsqlite3_mprintf(tls, ts+24736, libc.VaList(bp+440, zObj))
			...
			for 1 != 0 {
				...
				zSql = sqlite3.Xsqlite3_mprintf(tls, ts+24736, libc.VaList(bp+448, zObj))
				speedtest1_exec(tls, zSql, 0)
				sqlite3.Xsqlite3_free(tls, zSql)
				sqlite3.Xsqlite3_free(tls, zObj)
			}
	...
	if showStats != 0 {
		sqlite3.Xsqlite3_exec(tls, g.db, ts+24827, *(*uintptr)(unsafe.Pointer(&struct {
			f func(*libc.TLS, uintptr, int32, uintptr, uintptr) int32
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, ts+24850, libc.VaList(bp+456, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_LOOKASIDE_HIT, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+24895, libc.VaList(bp+472, *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+24931, libc.VaList(bp+480, *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+24967, libc.VaList(bp+488, *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_USED, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25003, libc.VaList(bp+496, *(*int32)(unsafe.Pointer(bp + 608))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_HIT, bp+608, bp+612, 1)
		libc.Xprintf(tls, ts+25045, libc.VaList(bp+504, *(*int32)(unsafe.Pointer(bp + 608))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_MISS, bp+608, bp+612, 1)
		libc.Xprintf(tls, ts+25081, libc.VaList(bp+512, *(*int32)(unsafe.Pointer(bp + 608))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_WRITE, bp+608, bp+612, 1)
		libc.Xprintf(tls, ts+25117, libc.VaList(bp+520, *(*int32)(unsafe.Pointer(bp + 608))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_SCHEMA_USED, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25153, libc.VaList(bp+528, *(*int32)(unsafe.Pointer(bp + 608))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_STMT_USED, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25195, libc.VaList(bp+536, *(*int32)(unsafe.Pointer(bp + 608))))
	}
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, ts+25237, libc.VaList(bp+544, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_MALLOC_COUNT, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25282, libc.VaList(bp+560, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_PAGECACHE_OVERFLOW, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25327, libc.VaList(bp+576, *(*int32)(unsafe.Pointer(bp + 608)), *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_MALLOC_SIZE, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25372, libc.VaList(bp+592, *(*int32)(unsafe.Pointer(bp + 612))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_PAGECACHE_SIZE, bp+608, bp+612, 0)
		libc.Xprintf(tls, ts+25414, libc.VaList(bp+600, *(*int32)(unsafe.Pointer(bp + 612))))
	}
