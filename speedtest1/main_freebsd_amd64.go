...
func __maskrune(tls *libc.TLS, _c int32, _f uint64) int32 {
...
func __sbmaskrune(tls *libc.TLS, _c int32, _f uint64) int32 {
...
func __sbistype(tls *libc.TLS, _c int32, _f uint64) int32 {
	return libc.BoolInt32(!!(__sbmaskrune(tls, _c, _f) != 0))
}

func __sbmaskrune_l(tls *libc.TLS, __c int32, __f uint64, __loc uintptr) int32 {
	bp := tls.Alloc(4)
	defer tls.Free(4)
...
func __sbistype_l(tls *libc.TLS, __c int32, __f uint64, __loc uintptr) int32 {
...
func integerValue(tls *libc.TLS, zArg uintptr) int32 {
	...
	if int32(*(*int8)(unsafe.Pointer(zArg))) == '0' && int32(*(*int8)(unsafe.Pointer(zArg + 1))) == 'x' {
		...
		for __sbistype(tls, int32(*(*int8)(unsafe.Pointer(zArg))), uint64(X_CTYPE_D)) != 0 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for n > 0 && (int32(*(*int8)(unsafe.Pointer(zSql + uintptr(n-1)))) == ';' || __sbistype(tls, int32(uint8(*(*int8)(unsafe.Pointer(zSql + uintptr(n-1))))), uint64(X_CTYPE_S)) != 0) {
		n--
	}
	if g.bExplain != 0 {
