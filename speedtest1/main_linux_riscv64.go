...
func speedtest1_end_test(tls *libc.TLS) {
	...
	if !(g.bSqlOnly != 0) {
		*(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 24)) += iElapseTime
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.bVerify != 0 {
		...
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			libc.Xprintf(tls, ts+3163, libc.VaList(bp+40, int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3152 + 259 + uintptr(i))))))
		}
			...
			if g.bVerify != 0 {
				...
				*(*uint8)(unsafe.Pointer(bp + 8 + 1)) = *(*uint8)(unsafe.Pointer(ts + 3270 + uintptr(eType)))
				...
				if eType == SQLITE_FLOAT {
					*(*uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 120)) += uint64(2)
					...
					*(*uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 120)) += uint64(nBlob*2 + 2)
				} else {
					HashUpdate(tls, z, uint32(len))
					*(*uint64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 120)) += uint64(len + 2)
				}
			}
			if uint64(g.nResult+len) < uint64(unsafe.Sizeof([3000]uint8{}))-uint64(2) {
				if g.nResult > 0 {
					*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 132 + uintptr(libc.PostIncInt32(&g.nResult, 1)))) = uint8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+132+uintptr(g.nResult), z, uint64(len+1))
				*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 128)) += len
			}
		}
	}
	if g.bReprepare != 0 {
...
func testset_main(tls *libc.TLS) {
	...
	*(*uint8)(unsafe.Pointer(bp + 568)) = uint8(0)
	...
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			...
			*(*uint8)(unsafe.Pointer(bp + 568)) = uint8('%')
			len = speedtest1_numbername(tls, uint32(i), bp+568+uintptr(1), int32(uint64(unsafe.Sizeof([2000]uint8{}))-uint64(2)))
	...
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = swizzle(tls, uint32(i), uint32(maxb))
			len = speedtest1_numbername(tls, x1, bp+568, int32(uint64(unsafe.Sizeof([2000]uint8{}))-uint64(1)))
		}
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	for i = uint32(0); i < n; i++ {
		...
		speedtest1_run(tls)
		*(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132)
	}
	speedtest1_end_test(tls)
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132) {
				fatal_error(tls, ts+10460,
					libc.VaList(bp+16, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132) {
				fatal_error(tls, ts+10460,
					libc.VaList(bp+64, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	for i = uint32(0); i < n; i++ {
		...
		if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132) {
			fatal_error(tls, ts+10460,
				libc.VaList(bp+112, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+132)))
		}
	}
	speedtest1_end_test(tls)
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*uint8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23594) == 0 {
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23632, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8))
			} else if libc.Xstrcmp(tls, z, ts+23719) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8))
			} else if libc.Xstrcmp(tls, z, ts+23723) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23632, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), ts+23805) == 0 {
					g.hashFile = libc.Xstdout
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), ts+23807)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23810, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23840) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23632, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				if g.pScript != 0 {
					libc.Xfclose(tls, g.pScript)
				}
				g.pScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8)), ts+23807)
				if g.pScript == uintptr(0) {
					fatal_error(tls, ts+23927, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				i++
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				zVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8))
			} else if libc.Xstrcmp(tls, z, ts+24100) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23632, libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
