...
func integerValue(tls *libc.TLS, zArg uintptr) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(zArg))) == '0' && int32(*(*uint8)(unsafe.Pointer(zArg + 1))) == 'x' {
		...
		for libc.Xisdigit(tls, int32(*(*uint8)(unsafe.Pointer(zArg)))) != 0 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for n > 0 && (int32(*(*uint8)(unsafe.Pointer(zSql + uintptr(n-1)))) == ';' || libc.Xisspace(tls, int32(*(*uint8)(unsafe.Pointer(zSql + uintptr(n-1))))) != 0) {
		n--
	}
	if g.bExplain != 0 {
...
func traceCallback(tls *libc.TLS, NotUsed uintptr, zSql uintptr) {
	...
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, ts+3177, libc.VaList(bp, n, zSql))
}
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*uint8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23321) == 0 {
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23359, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8))
			} else if libc.Xstrcmp(tls, z, ts+23446) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8))
			} else if libc.Xstrcmp(tls, z, ts+23450) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23359, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), ts+23532) == 0 {
					g.hashFile = uintptr(unsafe.Pointer(&libc.X__sF)) + 1*152
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), ts+23534)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23537, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23567) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23359, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				if g.pScript != 0 {
					libc.Xfclose(tls, g.pScript)
				}
				g.pScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8)), ts+23534)
				if g.pScript == uintptr(0) {
					fatal_error(tls, ts+23654, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				i++
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				zVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*8))
			} else if libc.Xstrcmp(tls, z, ts+23827) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23359, libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
